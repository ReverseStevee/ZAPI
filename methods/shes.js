...
function getRandomUserAgent() {
 ...
 if (process.argv.length < 7){console.log(`Usage: node h22.js host time req thread proxy.txt`); process.exit();}
...
console.clear()
console.log(`
Methods H22 By t.me/@stevenstresser⠀⠀⠀⠀
`)
console.log(`-----------------Methods H22 By t.me/@stevenstresser-------------------------`)
console.log(`Target: `+ process.argv[2])
console.log(`Time: `+ process.argv[3])
console.log(`Rate: `+ process.argv[4])
console.log(`Thread:` + process.argv[5])
console.log(`-------------------Succesfully Attack By Steven-Stresser🕊🪽-----------------------`)
console.log(`Gunakan Proxy Fresh/Premium Agar Powernya High`)
console.log(`------------------------------------------`)
console.log(`Methods: H22`)
console.log(`Methods H22 DDoS By t.me/@stevenstresser`)
console.log(`------------------------------------------`)
